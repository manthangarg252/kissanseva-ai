...
import { Button } from "@/components/ui/button";
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";
import { AlertCircle, UploadCloud, Tractor, FileUp } from "lucide-react";
import Image from "next/image";
import { detectLivestockDiseaseAndSuggestTreatment, type DetectLivestockDiseaseAndSuggestTreatmentOutput } from "@/ai/flows/detect-livestock-disease-and-suggest-treatment";
import { Badge } from "@/components/ui/badge";
...
export default function LivestockCarePage() {
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8">
            <PageHeader title="Livestock Care" description="Advanced AI diagnosis for your livestock." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mt-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Livestock Diagnosis</CardTitle>
                        <CardDescription>Upload an animal image for AI diagnosis.</CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        >
                            ...
                            {preview ? (
                                <Image src={preview} alt="Livestock preview" fill style={{ objectFit: "contain" }} />
                            ) : (
                                <div className="flex flex-col items-center gap-2 text-muted-foreground">
                                    <FileUp className="w-8 h-8" />
                                    <p className="font-semibold">Click to upload an image</p>
                ...
                <Card className="sticky top-24">
                    <CardHeader>
                        <CardTitle>Diagnosis Result</CardTitle>
                        <CardDescription>AI-powered livestock health analysis.</CardDescription>
                    </CardHeader>

                    <CardContent className="min-h-[300px] flex items-center justify-center">
                        {isLoading && (
                            <div className="text-center">
                                <UploadCloud className="mx-auto h-12 w-12 animate-bounce text-muted-foreground" />
                                <p className="mt-4">Diagnosing... please wait.</p>
                            </div>
                        )}
                        ...
                        {result && (
                            <div className="w-full space-y-4">
                                <p>
                                    <strong>Breed Prediction:</strong> <Badge>{result.breed}</Badge>
                                </p>
                                ...
                                <div>
                                    ...
                                    {(!result.possibleDiseases || result.possibleDiseases.length === 0) && (
                                        <p className="text-sm text-muted-foreground">
                                            No specific diseases detected with high confidence.
                                        </p>
                                    )}
                                </div>
